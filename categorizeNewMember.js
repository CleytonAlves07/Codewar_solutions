...
Senior and Open. They would like your help with
an application form that will tell prospective members 
...
//   let listOfOpenOrSenior = []
//   for (let i in data) {
//     let handicap = data[i][1]
//     let age = data[i][0]
//     if (handicap <= 7 || age < 55) {
//       listOfOpenOrSenior.push('Open')
//     } else {
//       listOfOpenOrSenior.push('Senior')
//     }
...
function openOrSenior(data) {
  return data.map(([age, handicap]) => handicap <= 7 || age < 55 ? 'Open' : 'Senior');
}
